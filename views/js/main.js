  ...
  function changeSliderLabel(size) {
    ...
    switch(size) {
      case "1":
        ...
        document.querySelector("#randomPizzas").classList.add("select_small");
        return;
      case "2":
        document.querySelector("#pizzaSize").innerHTML = "Medium";
        document.querySelector("#randomPizzas").classList.add("select_medium");
        return;
      case "3":
        document.querySelector("#pizzaSize").innerHTML = "Large";
        document.querySelector("#randomPizzas").classList.add("select_large");
        return;
      default:
